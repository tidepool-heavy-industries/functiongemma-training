#!/usr/bin/env python3
"""
Merge LoRA adapters for LSP symbol selection model
...
ADAPTER_PATH = "./training-runs/lsp/2026-01-17/checkpoints/final_lora"
OUTPUT_PATH = "./training-runs/lsp/2026-01-17/merged_model_fp32"

print("=" * 80)
print("Merging LoRA Adapters for LSP Symbol Selection")
print("=" * 80)
